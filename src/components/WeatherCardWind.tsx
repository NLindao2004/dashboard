...
interface WeatherCardProps {
  ...
  loading?: boolean; // Nueva prop para indicar si está cargando
}
...
export default function WeatherCard({
  ...
  details,
  imageUrl,
  loading = false, // Por defecto, no está en estado de carga
}: WeatherCardProps) {
  return (
    <Paper
      sx={{
        ...
        backgroundImage: !loading && imageUrl
          ? `url(${imageUrl})`
          : `url('https://raw.githubusercontent.com/NLindao2004/dashboard/refs/heads/main/src/Imagenes/defaultWind.webp')`,
